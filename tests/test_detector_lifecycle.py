...
class LifecycleTests(unittest.TestCase):
    ...
    def test_prepare_downloads_then_reuses(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            with patch.object(lifecycle,"download_mirror",side_effect=OSError("offline")), patch.object(lifecycle,"publish_mirror",return_value="skipped-no-token"), patch.object(lifecycle,"_download",side_effect=fake), patch.object(lifecycle.cv2.dnn,"readNet",return_value=net):
