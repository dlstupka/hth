...
class ChromaticNormalizationTests(unittest.TestCase):
            ...
            plan = {
                ...
                "resource_utilization": {
                    ...
                    "canonical_evidence_cache": {
                        "scope": CHROMATIC_INTEGRATION_SCOPE,
                        "path": "normalization/chromatic-integration/canonical-build-evidence.json",
    ...
    def test_workflows_use_cached_release_and_cbe(self) -> None:
        ...
        self.assertEqual(core.count('--github-summary "$GITHUB_STEP_SUMMARY"'), 4)
        self.assertEqual(integration.count('--github-summary "$GITHUB_STEP_SUMMARY"'), 6)
