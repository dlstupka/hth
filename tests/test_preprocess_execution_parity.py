...
class PreprocessExecutionParityTests(unittest.TestCase):
    ...
    def test_results_checkout_is_shallow_sparse_and_includes_reusable_caches(self):
        ...
        self.assertNotIn("/learned-evidence/", block)
    ...
    def test_preprocess_uses_managed_runtime_contract(self):
        ...
        self.assertIn("HTH_EVIDENCE_LOCAL_CACHE_ROOT", action)
        self.assertIn('/tmp/.ar/.hth-evidence-cache', action)
        self.assertIn('$RUNNER_TEMP/hth-evidence-cache', action)
