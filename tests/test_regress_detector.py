...
def test_initial_black_box_detectors_are_registered() -> None:
    assert set(DETECTORS) >= {"components", "grabcut", "contour", "convex_hull", "distance_transform", "contour_quad", "contour_components", "contour_grabcut", "grabcut_contour", "contour_projection", "consensus_quad", "radial_edge", "adaptive_radial_edge", "hough", "lsd"}
    assert all(
