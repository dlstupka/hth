...
def _write_debug_page(
    ...
    *,
    ...
    if candidate.get("method") == "components":
        ...
        overlay_name = "07-overlay.jpg"
        diagnostics_name = "08-diagnostics.json"
    elif candidate.get("method") in {"radial_edge", "adaptive_multi_scale_radial_edge", "amsre_bfq_spbv_pbg", "msre_bfq_spbv_pbg", "adaptive_radial_edge", "multi_scale_radial_edge", "projective_gradient_vote", "border_fusion_quad", "border_energy", "convex_hull", "distance_transform", "distance_transform_rect", "dhsegment_page_mask", "eynollah_page_mask", "docextractor_page_mask", "pagenet_page_mask", "doc_ufcn_page_mask", "mask_rcnn_page_mask", "polar_boundary_vote", "page_background", "signed_polar_boundary_vote", "segment_supported_polar_vote", "star_convex", "radon_boundary", "text_flow", "whitespace_frame", "joint_rectangle_vote", "learned_page_mask"} or (
