...
PRECOMPUTED_EVIDENCE_PREPARERS={
    ...
    "amsre_doc_ufcn_fusion":detector_doc_ufcn_page_mask.precompute_golden_set_evidence,
...
PRECOMPUTED_EVIDENCE_LOADERS={
    ...
    "amsre_doc_ufcn_fusion":detector_doc_ufcn_page_mask.load_precomputed_golden_set_evidence,
...
def _write_debug_page(
    ...
    *,
    ...
    if candidate.get("method") == "components":
        ...
        overlay_name = "07-overlay.jpg"
        diagnostics_name = "08-diagnostics.json"
    elif candidate.get("method") in {"radial_edge", "adaptive_multi_scale_radial_edge", "amsre_bfq_spbv_pbg", "amsre_doc_ufcn_fusion", "msre_bfq_spbv_pbg", "adaptive_radial_edge", "multi_scale_radial_edge", "projective_gradient_vote", "border_fusion_quad", "border_energy", "convex_hull", "distance_transform", "distance_transform_rect", "dhsegment_page_mask", "eynollah_page_mask", "docextractor_page_mask", "pagenet_page_mask", "doc_ufcn_page_mask", "mask_rcnn_page_mask", "polar_boundary_vote", "page_background", "signed_polar_boundary_vote", "segment_supported_polar_vote", "star_convex", "radon_boundary", "text_flow", "whitespace_frame", "joint_rectangle_vote", "learned_page_mask"} or (
        ...
        module = {
            ...
            "amsre_doc_ufcn_fusion": detector_amsre_doc_ufcn_fusion,
        ...
        basic_names_by_method = {
            ...
            "amsre_doc_ufcn_fusion": ["fusion-gen3-child-arbitration.png"],
...
def run(args:argparse.Namespace)->Path:
    ...
    model_env_suffix = name.upper().replace("-", "_")
    active_model_variant=str(os.environ.get(f"HTH_MODEL_VARIANT_{model_env_suffix}") or "").strip() or None
    active_model_id=str(os.environ.get(f"HTH_MODEL_ID_{model_env_suffix}") or "").strip() or None
    active_model_provenance=str(os.environ.get(f"HTH_MODEL_PROVENANCE_{model_env_suffix}") or "").strip() or None
    model_selection = None
    if active_model_variant or active_model_id or active_model_provenance:
        model_selection={
            "variant": active_model_variant,
            "model_id": active_model_id,
            "provenance": active_model_provenance,
        }
