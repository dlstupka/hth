...
from hth.geometry import detector_adaptive_radial_edge, detector_border_energy, detector_border_fusion_quad, detector_components, detector_convex_hull, detector_consensus_quad, detector_contour_components, detector_contour_grabcut, detector_cross_edge_contour, detector_distance_transform, detector_distance_transform_rect, detector_polar_boundary_vote, detector_page_background, detector_signed_polar_boundary_vote, detector_segment_supported_polar_vote, detector_star_convex, detector_grabcut, detector_grabcut_contour, detector_gradient_vote, detector_multi_scale_radial_edge, detector_projective_gradient_vote, detector_radial_edge, detector_contour_projection, detector_contour_quad, detector_ransac, detector_radon_boundary, detector_text_flow, detector_whitespace_frame, detector_joint_rectangle_vote, detector_learned_page_mask
...
def _write_debug_page(
    ...
    *,
    ...
    if candidate.get("method") == "components":
        ...
        overlay_name = "07-overlay.jpg"
        diagnostics_name = "08-diagnostics.json"
    elif candidate.get("method") in {"radial_edge", "adaptive_radial_edge", "multi_scale_radial_edge", "projective_gradient_vote", "border_fusion_quad", "border_energy", "convex_hull", "distance_transform", "distance_transform_rect", "polar_boundary_vote", "page_background", "signed_polar_boundary_vote", "segment_supported_polar_vote", "star_convex", "radon_boundary", "text_flow", "whitespace_frame", "joint_rectangle_vote", "learned_page_mask"} or (
...
def run(args:argparse.Namespace)->Path:
    ...
    try:
        ...
        write_json(run_dir/"parameters.json",{"schema_version":"0.4","detector":name,"strategy":effective_strategy,"requested_strategy":requested_strategy,"strategy_fallback_reason":strategy_fallback_reason,"detector_config":str(args.detector_config),"golden_set":str(args.golden_set),"golden_set_sha256":golden_set_sha256,"image_root":str(args.image_root),"max_dimension":args.max_dimension,"limit":args.limit,"threads":args.threads,"debug_level":debug_level,"debug_artifacts":debug_policy,"detector_pipeline":detector_pipeline_context,"shard":{"index":args.shard_index,"count":args.shard_count,"assignment":"interleaved"},"configuration":config})
