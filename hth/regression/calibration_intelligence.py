...
_DETECTOR_EVIDENCE: dict[str, dict[str, Any]] = {
    "learned_page_mask": {"friendly_name":"Learned Page-Mask Detector","short_name":"Learned Page Mask","role":"Generator","evidence":[("Learned segmentation","Primary","Predicts per-pixel page-membership evidence with a versioned external ONNX model."),("Probability threshold","Generator","Converts the learned probability field into a candidate page mask."),("Dominant page region","Geometry","Selects the largest learned page region and fits a quadrilateral page boundary."),("Model identity","Provenance","Records the model SHA-256 and fixed HTH inference contract with every candidate.")]},
