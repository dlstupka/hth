...
- [Photometric method assessment and validation](photometric-method-assessment.md) — deterministic method comparison followed by a complete held-out collection audit.
