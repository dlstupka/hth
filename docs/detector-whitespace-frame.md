...
`whitespace_frame` is an HTH document/page detector in the authoritative geometry registry.

## Approach

The detector operates by surrounding bright negative space is used to isolate an enclosed page region. The method treats viewer/background whitespace as evidence rather than page content.
